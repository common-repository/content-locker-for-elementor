	...
	class Recommended_Plugins extends Recommended {
		...
		public function admin_menu() {
			...
			$this->sub_menu = add_submenu_page(
				'options-general.php',       // Ex. content-locker-for-elementor-settings /  edit.php?post_type=page .
				__( 'Recommended', 'content-locker-for-elementor' ),
				__( 'Recommended', 'content-locker-for-elementor' ),
				'manage_options',
				'content-locker-for-elementor-recommended-plugins',
